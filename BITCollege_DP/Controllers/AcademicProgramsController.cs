...
namespace BITCollege_DP.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            // Prevent default cascading deletions.
            // Identify the record for deletion, and clear the relationship prior to deletion.
            // This is done to detach the related child records from the AcademicProgram being deleted, thus preserving the child records.
